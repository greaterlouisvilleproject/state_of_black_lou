...
stl_wgt<-function(df,var){
  df$var <- df[[var]]
  stl.16<-subset(df, year==2016 & (FIPS==29189|FIPS==29510))
  stl.wgt.16<-weighted.mean(stl.16$var, c(.758,.242))
  ...
  stl<-c(stl.wgt.16,stl.wgt.15,stl.wgt.14,stl.wgt.13,stl.wgt.12,stl.wgt.11,stl.wgt.10,stl.wgt.09,
...
stl_bl_unemp = stl_wgt(peer_unemployment, "bl_unemployment")
stl_unemp_ratio = stl_wgt(peer_unemployment, "peer_unemp_ratio")
stl_unemp = full_join(stl_bl_unemp, stl_unemp_ratio, by= c("FIPS", "year", "current"))%>%
  select(FIPS, year, bl_unemployment, peer_unemp_ratio)

peer_unemployment = rbind(peer_unemployment, stl_unemp)
peer_unemployment = peer_unemployment %>%
...
#Unemployment black/white ratio in Louisville and peer cities
...
Youth unemployment addition
```{r, message = FALSE}
if(!dir.exists("Youth Unemployment")){
  dir.create("Youth Unemployment")
}
setwd("Youth Unemployment")
showtext.auto()

#Youth male unemployment
png("Male Youth Unemployment.png", 2700, 1800, res = 300, type = "cairo")
two_var_trend(lville_unemployment, 
              "bl_male_unemployment_16_24", 
              "wh_male_unemployment_16_24", 
              "Black", 
              "White", 
              "Male Unemployment Rate in Louisville by Race, Ages 16-24", 
              colors = c("orange", "darkblue"),
              y_upper = 60,
              caption_text = "Source: Greater Louisville Project \n Data from American Community Survey Tables B23002A and B23002B")
dev.off()
...
png("Female Youth Unemployment.png", 2700, 1800, res = 300, type = "cairo")
two_var_trend(lville_unemployment, 
              "bl_female_unemployment_16_24", 
              "wh_female_unemployment_16_24", 
              "Black",
              "White", 
              "Female Unemployment Rate in Louisville by Race, Ages 16-24", 
              colors = c("orange", "darkblue"),
              y_upper = 60,
              caption_text = "Source: Greater Louisville Project \n Data from American Community Survey Tables B23002A and B23002B")
dev.off()
...
#Youth unemployment
png("Youth unemployment.png", 2700, 1800, res = 300, type = "cairo")
two_var_trend(lville_unemployment,
              "bl_unemployment_16_24", 
              "wh_unemployment_16_24",
              "Black",
              "White", 
              "Unemployment Rate in Louisville by Race, Ages 16-24", 
              y_upper = 60,
              colors = c("orange", "darkblue"),
              caption_text = "Source: Greater Louisville Project \n Data from American Community Survey Tables B23002A and B23002B")
dev.off()
...
Youth unempliyment peer city comparison
```{r}
if(!dir.exists("Youth Unemployment")){
  dir.create("Youth Unemployment")
}
...
png("Youth unemployment, peer cities.png", 2700, 1800, res = 300, type = "cairo")
two_var_trend(peer_and_lville,
              "lv_unemp_ratio", 
              "unemp_ratio_16_24",
              "Louisville", 
...
png("Black youth unemployment, peer cities.png", 2700, 1800, res = 300, type = "cairo")
two_var_trend(peer_and_lville, 
              "lv_bl_unemp", 
              "bl_unemployment_16_24", 
              "Louisville",
              "Peer City Mean", 
              "Black Unemployment in Louisville and Peer Cities, Ages 16-24", 
              colors = c("purple", "green"),
              y_upper = 60,
...
```{r, message=FALSE}
#BLACK
black_educ_data = acs_time("C:/Users/Harrison Kirby/Desktop/GLP/state_of_black_lou/input data/Education/Black",
                           starting.year = 2008)
...
#WHITE
white_educ_data = acs_time("C:/Users/Harrison Kirby/Desktop/GLP/state_of_black_lou/input data/Education/White",
                           starting.year = 2008)
...
educ_hist = educ_hist +
  labs(title = "Highest Level of Educational Attainment in Lousville\nby Race and Gender, 2011-2016", 
       y="Percent", 
...
```{r, message = FALSE}
black_income_data = acs_time("C:/Users/Harrison Kirby/Desktop/GLP/state_of_black_lou/input data/Income/Black")
...
white_income_data = acs_time("C:/Users/Harrison Kirby/Desktop/GLP/state_of_black_lou/input data/Income/White")
...
```{r}
#BLACK
black_pov_data = acs_time("C:/Users/Harrison Kirby/Desktop/GLP/state_of_black_lou/input data/Poverty/Black")
...
#WHITE
white_pov_data = acs_time("C:/Users/Harrison Kirby/Desktop/GLP/state_of_black_lou/input data/Poverty/White")
